...
// function useMessageCount(message, effect) {
//   useEffect(() => {
//     console.log("changing message length!")
//     // manually update the DOM...
//     effect(message.length)
//   }, [message])
// }
...
//   useMessageCount(message, length => {
//     const node = messageLengthRef.current
...
//   useEffect(() => {
//     if (!focused) {
//       console.log("Hold on, you are not done typing!!")
//     }
//   }, [focused])
